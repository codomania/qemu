...
/**
 * kvm_memcrypt_set_memory_region: indicate the memory region contains
 *                                 encrypted data.
 *
 * When memory region is marked as encrypted then debug access will use
 * encryption APIs and similarly migration will use call the encrypted
 * APIs.
 */
void kvm_memcrypt_set_memory_region(MemoryRegion *mr);
...
/**
 * kvm_memcrypt_encrypt_incoming_buffer - encrypt the outgoing buffer
 */
